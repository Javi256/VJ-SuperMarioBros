...
//If CTRL, ALT, SHIFT key is pressed this callback is called

/*static void shiftCallBack(int key, int x, int y)
{
	Game::instance().glutGetModifiers(key);
}*/
...
int main(int argc, char **argv)
{
	...
	glutInitWindowSize(SCREEN_WIDTH, SCREEN_HEIGHT); //scalefactor
